...
public partial class BlenderAdvancedImport : EditorScenePostImport
{
    ...
    public override GodotObject _PostImport(Node scene)
    {
        ...
        PhysicsBody3D body;
        StaticBody3D staticBody = model.GetChild<StaticBody3D>(0);
        ...
        if(modelName.EndsWith("-ani")) {
            model.Name = modelName.Substring(0, modelName.Length-"-ani".Length);
            ...
            model.Name = modelName.Substring(0, modelName.Length-"-rigid".Length);
